...
| Active as of 2026-06-08 | *Computable Name*:DataCategoryExtension |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.cqdg|current/StructureDefinition/StructureDefinition-DataCategoryExtension.json)
