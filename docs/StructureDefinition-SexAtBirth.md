...
| Active as of 2026-08-05 | *Computable Name*:SexAtBirth |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.cqdg|current/StructureDefinition/StructureDefinition-SexAtBirth.json)
