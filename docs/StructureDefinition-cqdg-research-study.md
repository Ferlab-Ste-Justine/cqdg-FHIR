...
| Active as of 2026-02-20 | *Computable Name*:CQDGResearchStudy |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.cqdg.ca/StructureDefinition/AccessRequirements"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.cqdg.ca/StructureDefinition/DataCategoryExtension"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.cqdg.ca/StructureDefinition/StudyDesignExtension"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.cqdg.ca/StructureDefinition/DataCollectionMethodExtension"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.cqdg.ca/StructureDefinition/ResearchStudy/ExpectedContent"]
      }]
    },
    {
