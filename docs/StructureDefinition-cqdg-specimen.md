...
| Active as of 2026-06-08 | *Computable Name*:CQDGSpecimen |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.cqdg|current/StructureDefinition/StructureDefinition-cqdg-specimen.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.cqdg.ca/StructureDefinition/CancerBiospecimenAnatomicLocation"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.cqdg.ca/StructureDefinition/TumorHistologicalType"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.cqdg.ca/StructureDefinition/CancerBiospecimenType"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://fhir.cqdg.ca/StructureDefinition/TumorNormalDesignation"]
      }]
    },
    {
