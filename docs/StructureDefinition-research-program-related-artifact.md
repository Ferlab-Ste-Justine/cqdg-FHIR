...
| Active as of 2026-06-08 | *Computable Name*:ResearchProgramRelatedArtifact |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.cqdg|current/StructureDefinition/StructureDefinition-research-program-related-artifact.json)
