...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'poreType']) &lt;= 1">extension with URL = 'poreType': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'isImputed']) &lt;= 1">extension with URL = 'isImputed': maximum cardinality of 'extension' is 1</sch:assert>
