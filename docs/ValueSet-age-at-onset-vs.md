# Ferlab.bio ValueSet/age-at-onset - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Ferlab.bio ValueSet/age-at-onset**

## ValueSet: Ferlab.bio ValueSet/age-at-onset 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.cqdg.ca/ValueSet/age-at-onset-vs | *Version*:0.1.0 |
| Active as of 2026-01-20 | *Computable Name*:AgeAtOnsetVS |
...
```json
{
  ...
  "id" : "age-at-onset-vs",
  "url" : "https://fhir.cqdg.ca/ValueSet/age-at-onset-vs",
  "version" : "0.1.0",
  "name" : "AgeAtOnsetVS",
