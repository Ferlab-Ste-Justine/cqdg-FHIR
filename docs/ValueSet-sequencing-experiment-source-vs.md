# Sequencing Experiment Source - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Sequencing Experiment Source**

## ValueSet: Sequencing Experiment Source 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.cqdg.ca/ValueSet/sequencing-experiment-source-vs | *Version*:0.1.0 |
| Active as of 2026-03-24 | *Computable Name*:SequencingExperimentSourceVS |
...
```json
{
  ...
  "id" : "sequencing-experiment-source-vs",
  "url" : "https://fhir.cqdg.ca/ValueSet/sequencing-experiment-source-vs",
  "version" : "0.1.0",
