...
* ^url = "http://fhir.cqdg.ca/CodeSystem/bioinfo-analysis-code"
* ^experimental = false
...
* #"RABA"  ^designation.use = http://fhir.cqdg.ca/CodeSystem/bioinfo-analysis-code#RABA //reads-alignement-bioinformatic-analysis
* #"RABA"  ^designation.value = "Reads Alignement Bioinformatic Analysis"

* #"SNVC"  "SNV Calling Bioinformatic Analysis"
* #"SNVC"  ^designation.use = http://fhir.cqdg.ca/CodeSystem/bioinfo-analysis-code#SNVC //snv-calling-bioinformatic-nalysis
* #"SNVC"  ^designation.value = "Reads Alignement Bioinformatic Analysis"

* #"QCBA"  "Quality Control Bioinformatic Analysis"
* #"QCBA"  ^designation.use = http://fhir.cqdg.ca/CodeSystem/bioinfo-analysis-code#QCBA //quality-control-bioinformatic-analysis
* #"QCBA"  ^designation.value = "Quality Control Bioinformatic Analysis"

* #"GEBA"  "Germline Exome Bioinformatic Analysis"
* #"GEBA"  ^designation.use = http://fhir.cqdg.ca/CodeSystem/bioinfo-analysis-code#GEBA //germline-exome-bioinformatic-analysis
* #"GEBA"  ^designation.value = "Germline Exome Bioinformatic Analysis"

* #"GGBA"  "Germline Genome Bioinformatic Analysis"
* #"GGBA"  ^designation.use = http://fhir.cqdg.ca/CodeSystem/bioinfo-analysis-code#GGBA //germline-genome-bioinformatic-analysis
