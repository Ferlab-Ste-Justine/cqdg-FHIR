...
* ^url = "http://fhir.cqdg.ca/CodeSystem/experimental-strategy"
* ^experimental = false
* ^description = "Experimental strategy"
* ^caseSensitive = true

* #"WXS" "Whole Exome Sequencing"
* #"WXS" ^designation.use = http://fhir.cqdg.ca/CodeSystem/experimental-strategy#WXS
* #"WXS" ^designation.value = "Whole Exome Sequencing"


* #"WGS" "Whole Genome Sequencing"
* #"WGS" ^designation.use = http://fhir.cqdg.ca/CodeSystem/experimental-strategy#WGS
* #"WGS" ^designation.value = "Whole Genome Sequencing"

* #"TARS" "Targeted Sequencing"
* #"TARS" ^designation.use = http://fhir.cqdg.ca/CodeSystem/experimental-strategy#TARS
