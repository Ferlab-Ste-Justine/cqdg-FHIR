...
* #"Cartagène" ^designation.use = https://fhir.cqdg.ca/CodeSystem/cqdg-study-cs#Cartagène //internal-label
...
* #"Developmental-and-Epileptic-Encephalopathies" ^designation.use = https://fhir.cqdg.ca/CodeSystem/cqdg-study-cs#Developmental-and-Epileptic-Encephalopathies //internal-label
* #"Developmental-and-Epileptic-Encephalopathies" ^designation.value = "Étude CARTaGENE"

* #"Other" "Other" "Another study"
* #"Other" ^designation.use = https://fhir.cqdg.ca/CodeSystem/cqdg-study-cs#Other
