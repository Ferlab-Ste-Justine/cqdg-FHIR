...
* extension[WorkflowExtension].extension[GenomeBuild].valueCoding.code = http://fhir.cqdg.ferlab.bio/CodeSystem/genome-build#GRCh38 "GRCh38"
* extension[WorkflowExtension].extension[GenomeBuild].valueCoding.display = http://fhir.cqdg.ferlab.bio/CodeSystem/genome-build#GRCh38 "GRCh38"
* extension[WorkflowExtension].extension[GenomeBuild].valueCoding.system = "http://fhir.cqdg.ferlab.bio/CodeSystem/genome-build"
...
* extension[SequencingExperimentExtension].extension[ExperimentalStrategy].valueCoding.code = http://fhir.cqdg.ferlab.bio/CodeSystem/experimental-strategy#WXS "Whole Exome Sequencing"
* extension[SequencingExperimentExtension].extension[ExperimentalStrategy].valueCoding.display = "Whole Exome Sequencing"
* extension[SequencingExperimentExtension].extension[ExperimentalStrategy].valueCoding.system = "http://fhir.cqdg.ferlab.bio/CodeSystem/experimental-strategy"
